...
if __name__ == '__main__':
    ...
    logging.basicConfig(level=logging.INFO, filename='/home/marcus/.config/i3/autologger')
    ...
    def event_handler(i3, e):
        if e.change in ['new', 'close', 'move', 'init', 'focus', 'empty']:
            rename_workspaces(i3)
